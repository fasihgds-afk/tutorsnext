...
const stats = [
  {
    id: 1, number: '500+', title: 'Expert Writers', subtitle: "PhD & Master's Level Experts",
    icon: (
  ...
  {
    id: 3, number: '8.3K+', title: 'Oders Completed', subtitle: 'High Quality Assignment Delivered',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
