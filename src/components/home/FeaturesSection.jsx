...
const features = [
  {
    ...
    Icon: featuresIcons.items[0],
  },
  {
    id: 2,
    title: '100% Personalized & Results-Focused',
    description: 'Every Written assignment is tailored to your goals and learning needs to help you truly understand and excel.',
    Icon: featuresIcons.items[1],
  },
  {
    id: 3,
    title: 'Personalized Learning Always',
    description: 'We value your time. Get focused, engaging writing tailored to your learning needs, every time.',
    Icon: featuresIcons.items[2],
  },
  {
    id: 4,
    ...
    Icon: featuresIcons.items[3],
  },
  {
    id: 5,
    title: 'Secure & Confidential',
    description: 'Your personal information and assignment details are 100% secure and confidential.',
    Icon: featuresIcons.items[4],
  },
  {
    id: 6,
    title: '24/7 Live Support',
    description: 'Friendly customer support available around the clock to assist you with any questions.',
    Icon: featuresIcons.items[5],
  },
];
