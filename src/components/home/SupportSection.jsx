...
import { support } from '../../config/sectionIcons';
...
const features = [
  ...
  },
  {
    ...
    Icon: support.cards[3],
  },
];

const trustMeta = [
  { label: 'Average Response: 2 Min', Icon: support.trust[2] },
  { label: '100% Confidential', Icon: support.trust[3] },
  { label: 'No Obligation', Icon: support.trust[4] },
];
        ...
        <div className="w-full bg-surface rounded-[20px] border border-card-border shadow-[0_4px_24px_rgba(0,0,0,0.03)] p-5 lg:p-8 mb-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center">
            ...
            <div className="lg:col-span-5 flex justify-center items-center">
              <img
                src="/images/CTA-3-removebg-preview.png"
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 text-center sm:text-left">
              <div className="relative shrink-0">
                <div className="w-[56px] h-[56px] rounded-full bg-surface flex items-center justify-center shadow-md hover:scale-110 transition-transform duration-300">
                  <Icon icon={support.banner} className="w-7 h-7 text-brand-purple" />
                </div>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-3 w-full sm:w-auto">
                ...
                <a href={SITE_CONFIG.phone.href}
                  ...
                  <span className="inline-flex items-center justify-center gap-2">
                    <Icon icon={support.trust[0]} className="w-4 h-4" />
                ...
                <a href={SITE_CONFIG.email.href}
                  ...
                  <span className="inline-flex items-center justify-center gap-2">
                    <Icon icon={support.trust[1]} className="w-4 h-4" />
