...
const Navbar = () => {
  ...
  return (
    <header className="header-main w-full bg-white shadow-sm border-b border-gray-100 sticky top-0 z-50">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 md:h-18">

          {/* Left: Logo */}
          <Link to="/" className="flex items-center shrink-0 header-logo-hover">
            <img
          ...
          <nav className="hidden xl:flex items-center gap-6">
            <a
              ...
              className="header-nav-link text-sm text-gray-700 font-medium hover:text-primary transition-colors whitespace-nowrap"
            >
            ...
            <Link to="/reviews" className="header-nav-link text-sm text-gray-700 font-medium hover:text-primary transition-colors whitespace-nowrap">
              Reviews
            </Link>
            <a
              href="/#services"
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {isHome1 ? (
              ...
              <a
                ...
                className="header-cta-button btn-fill-hover flex items-center gap-1.5 text-sm font-semibold px-4 py-2 rounded-full shadow-sm whitespace-nowrap"
              >
              ...
              /* Home: Hire A Writer (links to register) + Login */
              <>
                <Link
          ...
          <div className="flex md:hidden items-center">
            <button
              ...
              className="header-focus-ring text-gray-700 hover:text-gray-900 focus:outline-none p-2 rounded-md transition-colors duration-200"
        ...
        {isMobileMenuOpen && (
          <div className="header-dropdown header-mobile-menu md:hidden border-t border-gray-100 py-4 space-y-1 bg-white shadow-lg">
            <a
              href="/#top-writers"
